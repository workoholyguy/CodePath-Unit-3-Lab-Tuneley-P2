    ...
    override func viewDidLoad() {
        ...
        let task = URLSession.shared.dataTask(with: request) {
            ...
            do {
                ...
                //update the view controller's tracks property as well
                
                //and then call reloadData on the table view to make it reload now that we have new data for it to display.
