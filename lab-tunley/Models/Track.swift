...
extension Track {
    ...
    */
    ...
    struct TracksResponse: Decodable {
        ...
        /*
         Open the Track file and create a new struct model (outside of the Track struct) to represent the top level "response" object, where the results property is an array of Track. Just like we did with Track, we're trying to mirror the structure of the JSON data.
         */
        var results: [Track]
        
        //static var results: [TracksResponse] = []
        /*
        let trackName: String
        let artistName: String
        let artworkUrl100: URL
...
/*
 extension TracksResponse{
    static var results: [ResponseTracks] = [
